...
df_plot = df_selecao.sample(300, random_state=45)
...
def graphs():
    ...
    fig_bar = px.bar(
        ...
        color_discrete_map={
            'CAMPO LIMPO': '#FFDEDE',
            'CAPELA DO SOCORRO': '#FFEBEB',
            "M'BOI MIRIM": '#FFDADA',
            'CIDADE ADEMAR': '#FFC7C7',
            'PARELHEIROS': '#FFE0E0',
            'SANTO AMARO': '#FFF0F0',
            'ARICANDUVA/FORMOSA/CARRÃO': '#FF8585',
            'LAPA': '#FF9999',
            'BUTANTÃ': '#FF6F6F',
            'SÉ': '#FF7070',
            'MOOCA': '#FF7C7C',
            'PERUS': '#FF6666',
            'PIRITUBA/JARAGUA': '#FF4B4B',
            'CASA VERDE': '#E64545',
            'FREGUESIA DO Ó': '#D93B3B',
            'PENHA': '#C93030',
            'SANTANA/TUCURUVI': '#B82828',
            'VILA MARIA/VILA GUILHERME': '#A01F1F',
            'CIDADE TIRADENTES': '#FFDEDE',
            'ERMELINO MATARAZZO': '#FFEBEB',
            'GUAIANASES': '#FFDADA',
            'IPIRANGA': '#FFC7C7',
            'ITAQUERA': '#FFE0E0',
            'ITAIM PAULISTA': '#FFF0F0',
            'JABAQUARA': '#FF8585',
            'SÃO MIGUEL PAULISTA': '#FF9999',
            'SAPOPEMBA': '#FF6F6F',
            'SÃO MATEUS': '#FF7070',
            'VILA MARIANA': '#FF7C7C',
            'VILA PRUDENTE': '#FF6666',
            'PINHEIROS': '#FF4B4B',
            'JAÇANÃ/TREMEMBE': '#E64545'
        }
    )
    ...
    fig_hist = px.histogram(
        ...
        height=600,
        color='Subprefeitura',
        labels= {'count': "Pontos Viciados", "Contratada": "Empresa"},
        color_discrete_map={
            'CAMPO LIMPO': '#FFDEDE',
            'CAPELA DO SOCORRO': '#FFEBEB',
            "M'BOI MIRIM": '#FFDADA',
